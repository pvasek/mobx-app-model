...
/***/ function(module, exports, __webpack_require__) {
	...
	var mobx_1 = __webpack_require__(159);
	var mobx_react_1 = __webpack_require__(160);
	var store1 = mobx_1.observable({
	    title: 'test',
	    focused: null,
	    test: function () {
	        return this.title + '!!!';
	...
	var MyComp2 = mobx_react_1.observer(function (_a) {
	    var store = _a.store, store2 = _a.store2;
	    return (React.createElement("div", null, React.createElement("div", null, React.createElement("label", {onClick: function () { return store.title = new Date().toTimeString(); }}, "Title: "), React.createElement("span", null, store.title)), React.createElement("label", {onClick: function () { return store2.count = new Date().getMilliseconds(); }}, "Count"), React.createElement("span", null, store2.count), React.createElement("div", null, store.test)));
	});
	console.time('generating template...');
	var template = [];
	for (var i = 0; i < 3000; i++) {
	    var item = { id: i, focus: 0 };
	    for (var j = 0; j < 50; j++) {
	...
	var store = mobx_1.observable(template);
	...
	setInterval(function () {
	    var idx = Math.ceil(Math.random() * template.length) - 1;
	    store[idx].property_name_0 = "this is new text " + new Date();
	}, 10);
	var MyRow = mobx_react_1.observer(function (props) {
	    var item = props.item;
	    return (React.createElement("tr", null, React.createElement("td", null, item.id), React.createElement("td", null, item.property_name_0), React.createElement("td", {onClick: function () { return item.property_name_1 = count++; }}, item.property_name_1), React.createElement("td", null, React.createElement("input", {ref: "input", type: "text", value: item.property_name_2, onChange: function (e) { return item.property_name_2 = e.target.value; }})), React.createElement("td", {onClick: function () { return store1.focused = item; }}, item.property_name_2), React.createElement("td", null, item.property_name_4), React.createElement("td", null, item.property_name_5), React.createElement("td", null, item.property_name_6), React.createElement("td", null, item.property_name_7)));
	});
	//const View = observer((props: any) => (<div>{props.store.title}</div>));
	var MyTable = mobx_react_1.observer(function (props) { return (React.createElement("table", null, React.createElement("tbody", null, props.store.map(function (i) {
	    return (React.createElement(MyRow, {key: i.id, item: i}));
	})))); });
	var store12 = mobx_1.observable({ count: store2.count, title: store1.title });
	var MyComp = mobx_react_1.observer(function (_a) {
	    var store = _a.store;
	    return (React.createElement("div", null, React.createElement("div", null, React.createElement("label", {onClick: function () { return store.title = new Date().toTimeString(); }}, "Title"), React.createElement("span", null, store.title)), React.createElement("div", null, React.createElement("label", {onClick: function () { return store.count = new Date().getMilliseconds(); }}, "Count"), React.createElement("span", null, store.count))));
	});
	var Root = function (props) { return (React.createElement("div", null, React.createElement("h1", null, "Table3"), React.createElement(MyComp, {store: store12}), React.createElement(MyTable, {store: props.store}))); };
	console.time('rendering...');
	var appElement = document.getElementById('app');
	react_dom_1.render(React.createElement(Root, {store: store}), appElement);
